...
def main():
    ...
    parser.add_argument("--pretrained_model", default="./output/strengthnet2000.h5", type=str,
    ...
    for wavfile in tqdm(wavfiles):
        ...
        # make prediction
        Strength_score, Frame_score, emo_class = model.predict(
            mel_sgram, verbose=0, batch_size=1)

        # write to list
        result = wavfile + str(Strength_score)
